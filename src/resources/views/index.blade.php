...
<div class="div__main">
  ...
  <form class="form__contact" action="/confirm">
    ...
    <div class="div__email">
      ...
      <div class="div__input">
        <input class="input__email" type="text" id="input_email" name="email" placeholder="例:test@example.com" value="{{old ('email')}}" >
      </div>
    </div>
    <div class="form__error">
      <ul>
    ...
    <div class="div__category">
      ...
      <div class="div__input">
        <select class="select__category" id="select__category" name="category_id" onload="Color(this)" onchange="Color(this)">
